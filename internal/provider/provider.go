...
func (p *pfSenseProvider) DataSources(_ context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		NewDynamicDNSEntriesDataSource,
		NewDHCPv4ServerDataSource,
		...
		NewDNSResolverAdvancedDataSource,
		NewDNSResolverGeneralDataSource,
		...
		NewFirewallNATOneToOneRuleDataSource,
		NewFirewallNATOneToOneRulesDataSource,
		NewFirewallNATNPtRuleDataSource,
		NewFirewallNATNPtRulesDataSource,
		NewFirewallNATOutboundRuleDataSource,
		NewFirewallNATOutboundRulesDataSource,
		NewFirewallNATPortForwardDataSource,
		NewFirewallNATPortForwardsDataSource,
		NewFirewallRuleDataSource,
		NewFirewallRulesDataSource,
		NewFirewallScheduleDataSource,
		NewFirewallSchedulesDataSource,
		NewFirewallPortAliasDataSource,
		NewFirewallURLAliasDataSource,
		NewFirewallVirtualIPDataSource,
		...
		NewGroupDataSource,
		NewGroupsDataSource,
		NewIPsecPhase1DataSource,
		NewIPsecPhase1sDataSource,
		NewIPsecPhase2DataSource,
		NewIPsecPhase2sDataSource,
		NewOpenVPNServerDataSource,
		NewOpenVPNServersDataSource,
		NewInterfaceDataSource,
		NewInterfaceBridgeDataSource,
		NewInterfaceBridgesDataSource,
		...
		NewRouteDataSource,
		NewRoutesDataSource,
		NewSystemAdvancedAdminDataSource,
		NewSystemAdvancedFirewallDataSource,
		NewSystemAdvancedMiscDataSource,
		NewSystemAdvancedNetworkingDataSource,
		NewSystemAdvancedNotificationsDataSource,
		NewSystemGeneralDataSource,
...
func (p *pfSenseProvider) Resources(_ context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		NewDHCPv4ServerResource,
		NewDNSResolverConfigFileResource,
		NewDNSResolverDomainOverrideResource,
		NewDNSResolverAdvancedResource,
		NewDNSResolverGeneralResource,
		NewDNSResolverHostOverrideResource,
		NewFirewallIPAliasResource,
		NewFirewallNATOneToOneRuleResource,
		NewFirewallNATNPtRuleResource,
		NewFirewallNATOutboundRuleResource,
		NewFirewallNATPortForwardResource,
		NewFirewallPortAliasResource,
		NewFirewallRuleResource,
		NewFirewallScheduleResource,
		NewFirewallURLAliasResource,
		NewFirewallVirtualIPResource,
		NewGatewayResource,
		...
		NewSystemAdvancedFirewallResource,
		NewSystemAdvancedMiscResource,
		NewSystemAdvancedNotificationsResource,
